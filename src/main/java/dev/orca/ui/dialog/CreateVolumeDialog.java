...
public final class CreateVolumeDialog extends DialogWindow {
    ...
    public static Optional<Result> show(WindowBasedTextGUI gui) {
        CreateVolumeDialog dialog = new CreateVolumeDialog();
